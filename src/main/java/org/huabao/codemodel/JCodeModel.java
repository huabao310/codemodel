...
import org.huabao.codemodel.writer.FileCodeWriter;
import org.huabao.codemodel.writer.ProgressCodeWriter;
...
public final class JCodeModel {
    ...
    private static boolean getFileSystemCaseSensitivity() {
        try {
            ...
            // wants to override.
            if( System.getProperty("org.huabao.codemodel.FileSystemCaseSensitive")!=null )
                return true;
        } catch( Exception e ) {}
