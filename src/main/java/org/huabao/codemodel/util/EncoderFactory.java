 ...
 */
package org.huabao.codemodel.util;
	...
	public static CharsetEncoder createEncoder( String encodin ) {
        ...
        if( cs.getClass().getName().equals("sun.nio.cs.MS1252") ) {
            try {
                ...
                Class<? extends CharsetEncoder> ms1252encoder = (Class<? extends CharsetEncoder>) Class.forName("org.huabao.codemodel.util.MS1252Encoder");
